...
------------ | ------------- | ------------- | -------------
**items** | Option<[**Vec<models::HelloAssoApiV5CommonModelsStatisticsShareItem>**](HelloAssoApiV5CommonModelsStatisticsShareItem.md)> | Items linked to this payment and each share between the item and the payment | [optional]
