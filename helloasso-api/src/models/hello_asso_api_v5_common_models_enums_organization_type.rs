...
pub enum HelloAssoApiV5CommonModelsEnumsOrganizationType {
    #[serde(rename = "Association1901Rig")]
    Association1901Rig,
    #[serde(rename = "Association1901Rup")]
    Association1901Rup,
    #[serde(rename = "Association1901")]
    Association1901,
    #[serde(rename = "FondationRup")]
    FondationRup,
    #[serde(rename = "FondDotation")]
    FondDotation,
    #[serde(rename = "FondationSousEgide")]
    FondationSousEgide,
    #[serde(rename = "FondationScientifique")]
    FondationScientifique,
    #[serde(rename = "FondationPartenariale")]
    FondationPartenariale,
    #[serde(rename = "FondationUniversitaire")]
    FondationUniversitaire,
    #[serde(rename = "FondationHospitaliere")]
    FondationHospitaliere,
    #[serde(rename = "Association1905")]
    Association1905,
    #[serde(rename = "Association1905Rup")]
    Association1905Rup,
    #[serde(rename = "Entreprise")]
    Entreprise,
    #[serde(rename = "Cooperative")]
    Cooperative,
    #[serde(rename = "Etablissement")]
    Etablissement,
    #[serde(rename = "Association1908")]
    Association1908,
    #[serde(rename = "Association1908Rig")]
    Association1908Rig,
    #[serde(rename = "Association1908Rup")]
    Association1908Rup,
    #[serde(rename = "AssociationMilitaire")]
    AssociationMilitaire,
    #[serde(rename = "AssociationProprietaire")]
    AssociationProprietaire,
    #[serde(rename = "Collectivités")]
    Collectivits,
    #[serde(rename = "ComiteEntreprise")]
    ComiteEntreprise,
    #[serde(rename = "CSE")]
    Cse,
    #[serde(rename = "FabriqueEglise")]
    FabriqueEglise,
    #[serde(rename = "FondsPerenite")]
    FondsPerenite,
    #[serde(rename = "GIE")]
    Gie,
    #[serde(rename = "GIP")]
    Gip,
    #[serde(rename = "MenseCuriale")]
    MenseCuriale,
    #[serde(rename = "SCIC")]
    Scic,
    #[serde(rename = "SCOP")]
...
impl std::fmt::Display for HelloAssoApiV5CommonModelsEnumsOrganizationType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::Association1901Rig => write!(f, "Association1901Rig"),
            Self::Association1901Rup => write!(f, "Association1901Rup"),
            Self::Association1901 => write!(f, "Association1901"),
            Self::FondationRup => write!(f, "FondationRup"),
            Self::FondDotation => write!(f, "FondDotation"),
            Self::FondationSousEgide => write!(f, "FondationSousEgide"),
            Self::FondationScientifique => write!(f, "FondationScientifique"),
            Self::FondationPartenariale => write!(f, "FondationPartenariale"),
            Self::FondationUniversitaire => write!(f, "FondationUniversitaire"),
            Self::FondationHospitaliere => write!(f, "FondationHospitaliere"),
            Self::Association1905 => write!(f, "Association1905"),
            Self::Association1905Rup => write!(f, "Association1905Rup"),
            Self::Entreprise => write!(f, "Entreprise"),
            Self::Cooperative => write!(f, "Cooperative"),
            Self::Etablissement => write!(f, "Etablissement"),
            Self::Association1908 => write!(f, "Association1908"),
            Self::Association1908Rig => write!(f, "Association1908Rig"),
            Self::Association1908Rup => write!(f, "Association1908Rup"),
            Self::AssociationMilitaire => write!(f, "AssociationMilitaire"),
            Self::AssociationProprietaire => write!(f, "AssociationProprietaire"),
            Self::Collectivits => write!(f, "Collectivités"),
            Self::ComiteEntreprise => write!(f, "ComiteEntreprise"),
            Self::Cse => write!(f, "CSE"),
            Self::FabriqueEglise => write!(f, "FabriqueEglise"),
            Self::FondsPerenite => write!(f, "FondsPerenite"),
            Self::Gie => write!(f, "GIE"),
            Self::Gip => write!(f, "GIP"),
            Self::MenseCuriale => write!(f, "MenseCuriale"),
            Self::Scic => write!(f, "SCIC"),
            Self::Scop => write!(f, "SCOP"),
            Self::Autres => write!(f, "Autres"),
        }
    }
}

impl Default for HelloAssoApiV5CommonModelsEnumsOrganizationType {
    fn default() -> HelloAssoApiV5CommonModelsEnumsOrganizationType {
        Self::Association1901Rig
    }
}
