...
/// struct for typed errors of method [`items_item_id_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ItemsItemIdGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`orders_order_id_cancel_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrdersOrderIdCancelPostError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`orders_order_id_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrdersOrderIdGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_form_type_form_slug_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsFormTypeFormSlugItemsGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_form_type_form_slug_orders_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_items_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugItemsGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_orders_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugOrdersGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
pub async fn items_item_id_get(configuration: &configuration::Configuration, item_id: i32, with_details: Option<bool>) -> Result<models::HelloAssoApiV5CommonModelsStatisticsItemDetail, Error<ItemsItemIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_item_id = item_id;
    let p_query_with_details = with_details;

    let uri_str = format!("{}/items/{itemId}", configuration.base_path, itemId=p_path_item_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_with_details {
        req_builder = req_builder.query(&[("withDetails", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsStatisticsItemDetail`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsStatisticsItemDetail`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ItemsItemIdGetError> = serde_json::from_str(&content).ok();
...
pub async fn orders_order_id_cancel_post(configuration: &configuration::Configuration, order_id: i32) -> Result<(), Error<OrdersOrderIdCancelPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_order_id = order_id;

    let uri_str = format!("{}/orders/{orderId}/cancel", configuration.base_path, orderId=p_path_order_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrdersOrderIdCancelPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your token must have one of these roles : </b><br/>FormAdmin<br/>OrganizationAdmin<br/><br/>If you are an <b>association</b>, you can obtain these roles with your client.<br/>If you are a <b>partner</b>, you can obtain these roles by the authorize flow.<br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessTransactions<br/><br/>
pub async fn orders_order_id_get(configuration: &configuration::Configuration, order_id: i32, with_form_data: Option<bool>) -> Result<models::HelloAssoApiV5CommonModelsStatisticsOrderDetail, Error<OrdersOrderIdGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_order_id = order_id;
    let p_query_with_form_data = with_form_data;

    let uri_str = format!("{}/orders/{orderId}", configuration.base_path, orderId=p_path_order_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_with_form_data {
        req_builder = req_builder.query(&[("withFormData", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsStatisticsOrderDetail`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsStatisticsOrderDetail`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrdersOrderIdGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your token must have one of these roles : </b><br/>FormAdmin<br/>OrganizationAdmin<br/><br/>If you are an <b>association</b>, you can obtain these roles with your client.<br/>If you are a <b>partner</b>, you can obtain these roles by the authorize flow.<br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessTransactions<br/><br/>
pub async fn organizations_organization_slug_forms_form_type_form_slug_items_get(configuration: &configuration::Configuration, organization_slug: &str, form_slug: &str, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType, from: Option<String>, to: Option<String>, user_search_key: Option<&str>, page_index: Option<i32>, page_size: Option<i32>, continuation_token: Option<&str>, tier_types: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsTierType>>, item_states: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsItemState>>, tier_name: Option<&str>, with_details: Option<bool>, sort_order: Option<models::HelloAssoApiV5CommonModelsEnumsSortOrder>, sort_field: Option<models::HelloAssoApiV5CommonModelsEnumsSortField>) -> Result<(), Error<OrganizationsOrganizationSlugFormsFormTypeFormSlugItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let p_query_tier_types = tier_types;
    let p_query_item_states = item_states;
    let p_query_tier_name = tier_name;
    let p_query_with_details = with_details;
    let p_query_sort_order = sort_order;
    let p_query_sort_field = sort_field;

    let uri_str = format!("{}/organizations/{organizationSlug}/forms/{formType}/{formSlug}/items", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug), formSlug=crate::apis::urlencode(p_path_form_slug), formType=p_path_form_type.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_tier_types {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("tierTypes".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("tierTypes", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_item_states {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("itemStates".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("itemStates", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_tier_name {
        req_builder = req_builder.query(&[("tierName", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_with_details {
        req_builder = req_builder.query(&[("withDetails", &param_value.to_string())]);
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsFormTypeFormSlugItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your token must have one of these roles : </b><br/>FormAdmin<br/>OrganizationAdmin<br/><br/>If you are an <b>association</b>, you can obtain these roles with your client.<br/>If you are a <b>partner</b>, you can obtain these roles by the authorize flow.<br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessTransactions<br/><br/>
pub async fn organizations_organization_slug_forms_form_type_form_slug_orders_get(configuration: &configuration::Configuration, organization_slug: &str, form_slug: &str, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType, from: Option<String>, to: Option<String>, user_search_key: Option<&str>, page_index: Option<i32>, page_size: Option<i32>, continuation_token: Option<&str>, with_details: Option<bool>, sort_order: Option<models::HelloAssoApiV5CommonModelsEnumsSortOrder>) -> Result<models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelOrder, Error<OrganizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_path_form_slug = form_slug;
    let p_path_form_type = form_type;
    ...
    let uri_str = format!("{}/organizations/{organizationSlug}/forms/{formType}/{formSlug}/orders", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug), formSlug=crate::apis::urlencode(p_path_form_slug), formType=p_path_form_type.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelOrder`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelOrder`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsFormTypeFormSlugOrdersGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn organizations_organization_slug_items_get(configuration: &configuration::Configuration, organization_slug: &str, from: Option<String>, to: Option<String>, user_search_key: Option<&str>, page_index: Option<i32>, page_size: Option<i32>, continuation_token: Option<&str>, tier_types: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsTierType>>, item_states: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsItemState>>, tier_name: Option<&str>, with_details: Option<bool>, sort_order: Option<models::HelloAssoApiV5CommonModelsEnumsSortOrder>, sort_field: Option<models::HelloAssoApiV5CommonModelsEnumsSortField>) -> Result<(), Error<OrganizationsOrganizationSlugItemsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_query_from = from;
    let p_query_to = to;
    ...
    let uri_str = format!("{}/organizations/{organizationSlug}/items", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugItemsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your token must have one of these roles : </b><br/>OrganizationAdmin<br/><br/>If you are an <b>association</b>, you can obtain these roles with your client.<br/>If you are a <b>partner</b>, you can obtain these roles by the authorize flow.<br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessTransactions<br/><br/>
pub async fn organizations_organization_slug_orders_get(configuration: &configuration::Configuration, organization_slug: &str, from: Option<String>, to: Option<String>, user_search_key: Option<&str>, page_index: Option<i32>, page_size: Option<i32>, continuation_token: Option<&str>, form_types: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsFormType>>, with_details: Option<bool>, sort_order: Option<models::HelloAssoApiV5CommonModelsEnumsSortOrder>) -> Result<models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelOrder, Error<OrganizationsOrganizationSlugOrdersGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_query_from = from;
    let p_query_to = to;
    ...
    let p_query_page_size = page_size;
    let p_query_continuation_token = continuation_token;
    let p_query_form_types = form_types;
    let p_query_with_details = with_details;
    let p_query_sort_order = sort_order;

    let uri_str = format!("{}/organizations/{organizationSlug}/orders", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_form_types {
        req_builder = match "multi" {
            "multi" => req_builder.query(&param_value.into_iter().map(|p| ("formTypes".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => req_builder.query(&[("formTypes", &param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref param_value) = p_query_with_details {
        req_builder = req_builder.query(&[("withDetails", &param_value.to_string())]);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugOrdersGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
