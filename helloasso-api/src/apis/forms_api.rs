...
/// struct for typed errors of method [`organizations_organization_slug_form_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormTypesGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_form_type_action_quick_create_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsFormTypeActionQuickCreatePostError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_form_type_form_slug_public_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsFormTypeFormSlugPublicGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_form_type_form_slug_state_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsFormTypeFormSlugStatePutError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`organizations_organization_slug_forms_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OrganizationsOrganizationSlugFormsGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
pub async fn organizations_organization_slug_form_types_get(configuration: &configuration::Configuration, organization_slug: &str, states: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsFormState>>) -> Result<Vec<models::HelloAssoApiV5CommonModelsEnumsFormType>, Error<OrganizationsOrganizationSlugFormTypesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_query_states = states;

    let uri_str = format!("{}/organizations/{organizationSlug}/formTypes", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsEnumsFormType&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsEnumsFormType&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormTypesGetError> = serde_json::from_str(&content).ok();
...
pub async fn organizations_organization_slug_forms_form_type_action_quick_create_post(configuration: &configuration::Configuration, organization_slug: &str, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType, hello_asso_api_v5_common_models_forms_form_quick_create_request: Option<models::HelloAssoApiV5CommonModelsFormsFormQuickCreateRequest>) -> Result<models::HelloAssoApiV5CommonModelsFormsFormQuickCreateModel, Error<OrganizationsOrganizationSlugFormsFormTypeActionQuickCreatePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_path_form_type = form_type;
    let p_body_hello_asso_api_v5_common_models_forms_form_quick_create_request = hello_asso_api_v5_common_models_forms_form_quick_create_request;

    let uri_str = format!("{}/organizations/{organizationSlug}/forms/{formType}/action/quick-create", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug), formType=p_path_form_type.to_string());
    ...
    req_builder = req_builder.json(&p_body_hello_asso_api_v5_common_models_forms_form_quick_create_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsFormsFormQuickCreateModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsFormsFormQuickCreateModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsFormTypeActionQuickCreatePostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn organizations_organization_slug_forms_form_type_form_slug_public_get(configuration: &configuration::Configuration, organization_slug: &str, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType, form_slug: &str) -> Result<models::HelloAssoApiV5CommonModelsFormsFormPublicModel, Error<OrganizationsOrganizationSlugFormsFormTypeFormSlugPublicGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_path_form_type = form_type;
    let p_path_form_slug = form_slug;

    let uri_str = format!("{}/organizations/{organizationSlug}/forms/{formType}/{formSlug}/public", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug), formType=p_path_form_type.to_string(), formSlug=crate::apis::urlencode(p_path_form_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsFormsFormPublicModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsFormsFormPublicModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsFormTypeFormSlugPublicGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn organizations_organization_slug_forms_form_type_form_slug_state_put(configuration: &configuration::Configuration, organization_slug: &str, form_slug: &str, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType, hello_asso_api_v5_common_models_forms_form_state_request: Option<models::HelloAssoApiV5CommonModelsFormsFormStateRequest>) -> Result<(), Error<OrganizationsOrganizationSlugFormsFormTypeFormSlugStatePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_path_form_slug = form_slug;
    let p_path_form_type = form_type;
    let p_body_hello_asso_api_v5_common_models_forms_form_state_request = hello_asso_api_v5_common_models_forms_form_state_request;

    let uri_str = format!("{}/organizations/{organizationSlug}/forms/{formType}/{formSlug}/state", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug), formSlug=crate::apis::urlencode(p_path_form_slug), formType=p_path_form_type.to_string());
    ...
    req_builder = req_builder.json(&p_body_hello_asso_api_v5_common_models_forms_form_state_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsFormTypeFormSlugStatePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn organizations_organization_slug_forms_get(configuration: &configuration::Configuration, organization_slug: &str, states: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsFormState>>, form_types: Option<Vec<models::HelloAssoApiV5CommonModelsEnumsFormType>>, page_index: Option<i32>, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelFormLightModel, Error<OrganizationsOrganizationSlugFormsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_query_states = states;
    ...
    let uri_str = format!("{}/organizations/{organizationSlug}/forms", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelFormLightModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelFormLightModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<OrganizationsOrganizationSlugFormsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
