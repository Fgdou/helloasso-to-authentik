...
/// struct for typed errors of method [`values_company_legal_status_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValuesCompanyLegalStatusGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`values_form_form_type_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValuesFormFormTypeTypesGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`values_organization_categories_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValuesOrganizationCategoriesGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`values_tags_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ValuesTagsGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
/// <br/><br/>
pub async fn values_company_legal_status_get(configuration: &configuration::Configuration, ) -> Result<Vec<models::HelloAssoApiV5CommonModelsAccountsCompanyLegalStatusModel>, Error<ValuesCompanyLegalStatusGetError>> {

    let uri_str = format!("{}/values/company-legal-status", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsAccountsCompanyLegalStatusModel&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsAccountsCompanyLegalStatusModel&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ValuesCompanyLegalStatusGetError> = serde_json::from_str(&content).ok();
...
pub async fn values_form_form_type_types_get(configuration: &configuration::Configuration, form_type: models::HelloAssoApiV5CommonModelsEnumsFormType) -> Result<Vec<models::HelloAssoApiV5CommonModelsFormsFormActivityModel>, Error<ValuesFormFormTypeTypesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_form_type = form_type;

    let uri_str = format!("{}/values/form/{formType}/types", configuration.base_path, formType=p_path_form_type.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsFormsFormActivityModel&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsFormsFormActivityModel&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ValuesFormFormTypeTypesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Use this in order to build your category list of organization<br/><br/>
pub async fn values_organization_categories_get(configuration: &configuration::Configuration, ) -> Result<Vec<models::HelloAssoApiV5CommonModelsAccountsOrganismCategoryModel>, Error<ValuesOrganizationCategoriesGetError>> {

    let uri_str = format!("{}/values/organization/categories", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsAccountsOrganismCategoryModel&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsAccountsOrganismCategoryModel&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ValuesOrganizationCategoriesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn values_tags_get(configuration: &configuration::Configuration, ) -> Result<Vec<models::HelloAssoApiV5CommonModelsTagsPublicTagModel>, Error<ValuesTagsGetError>> {

    let uri_str = format!("{}/values/tags", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsTagsPublicTagModel&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::HelloAssoApiV5CommonModelsTagsPublicTagModel&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ValuesTagsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
