...
/// struct for typed errors of method [`partners_me_api_clients_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeApiClientsPutError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_api_notifications_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeApiNotificationsDeleteError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_api_notifications_organizations_organization_slug_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeApiNotificationsOrganizationsOrganizationSlugDeleteError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_api_notifications_organizations_organization_slug_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeApiNotificationsOrganizationsOrganizationSlugPutError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_api_notifications_put`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeApiNotificationsPutError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`partners_me_organizations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PartnersMeOrganizationsGetError {
    Status403(),
    Status401(),
    UnknownValue(serde_json::Value),
}
...
pub async fn partners_me_api_clients_put(configuration: &configuration::Configuration, hello_asso_api_v5_common_models_accounts_clients_public_put_api_client_request: Option<models::HelloAssoApiV5CommonModelsAccountsClientsPublicPutApiClientRequest>) -> Result<(), Error<PartnersMeApiClientsPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_hello_asso_api_v5_common_models_accounts_clients_public_put_api_client_request = hello_asso_api_v5_common_models_accounts_clients_public_put_api_client_request;

    let uri_str = format!("{}/partners/me/api-clients", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_hello_asso_api_v5_common_models_accounts_clients_public_put_api_client_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let entity: Option<PartnersMeApiClientsPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessPublicData<br/><br/>
pub async fn partners_me_api_notifications_delete(configuration: &configuration::Configuration, notification_type: Option<models::HelloAssoApiV5CommonModelsApiNotificationsApiNotificationType>) -> Result<(), Error<PartnersMeApiNotificationsDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_notification_type = notification_type;

    let uri_str = format!("{}/partners/me/api-notifications", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);

    if let Some(ref param_value) = p_query_notification_type {
        req_builder = req_builder.query(&[("notificationType", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PartnersMeApiNotificationsDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn partners_me_api_notifications_organizations_organization_slug_delete(configuration: &configuration::Configuration, organization_slug: &str, notification_type: Option<models::HelloAssoApiV5CommonModelsApiNotificationsApiNotificationType>) -> Result<(), Error<PartnersMeApiNotificationsOrganizationsOrganizationSlugDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_query_notification_type = notification_type;

    let uri_str = format!("{}/partners/me/api-notifications/organizations/{organizationSlug}", configuration.base_path, organizationSlug=crate::apis::urlencode(p_path_organization_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PartnersMeApiNotificationsOrganizationsOrganizationSlugDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your token must have one of these roles : </b><br/>OrganizationAdmin<br/><br/>If you are an <b>association</b>, you can obtain these roles with your client.<br/>If you are a <b>partner</b>, you can obtain these roles by the authorize flow.<br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessPublicData<br/><br/>
pub async fn partners_me_api_notifications_organizations_organization_slug_put(configuration: &configuration::Configuration, organization_slug: &str, hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body: Option<models::HelloAssoApiV5CommonModelsApiNotificationsPostApiUrlNotificationBody>) -> Result<models::HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel, Error<PartnersMeApiNotificationsOrganizationsOrganizationSlugPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_organization_slug = organization_slug;
    let p_body_hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body = hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body;
    ...
    req_builder = req_builder.json(&p_body_hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PartnersMeApiNotificationsOrganizationsOrganizationSlugPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessPublicData<br/><br/>
pub async fn partners_me_api_notifications_put(configuration: &configuration::Configuration, hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body: Option<models::HelloAssoApiV5CommonModelsApiNotificationsPostApiUrlNotificationBody>) -> Result<models::HelloAssoApiV5CommonModelsApiNotificationsApiUrlNotificationModel, Error<PartnersMeApiNotificationsPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body = hello_asso_api_v5_common_models_api_notifications_post_api_url_notification_body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PartnersMeApiNotificationsPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// <br/><br/><b>Your clientId must be allowed all of those privileges : </b> <br/> AccessPublicData<br/><br/>
pub async fn partners_me_get(configuration: &configuration::Configuration, ) -> Result<models::HelloAssoApiV5CommonModelsPartnersPartnerPublicModel, Error<PartnersMeGetError>> {

    let uri_str = format!("{}/partners/me", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsPartnersPartnerPublicModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsPartnersPartnerPublicModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PartnersMeGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn partners_me_organizations_get(configuration: &configuration::Configuration, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelPartnerOrganizationModel, Error<PartnersMeOrganizationsGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_page_size = page_size;
    let p_query_continuation_token = continuation_token;

    let uri_str = format!("{}/partners/me/organizations", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelPartnerOrganizationModel`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::HelloAssoApiV5CommonModelsCommonResultsWithPaginationModelPartnerOrganizationModel`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<PartnersMeOrganizationsGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
